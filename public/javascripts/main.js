...
window.onload = function () {
  ...
  if (document.title == "home") {
    ...
    document
      .getElementById("create_profile")
      .addEventListener("click", function (e) {
        window.location.replace(
          "https://trainer-atlas-1.herokuapp.com/complete_profile"
        );
      });

    //button event for displaying a dog
    document
      .getElementById("dog-image-btn")
      .addEventListener("click", function (e) {
    ...
    document.getElementById("delete_profile").addEventListener(
      "click",
      function (e) {
        //AJAX POST REQUEST
        const deleteUser = async () => {
          const response = await fetch(
            "https://trainer-atlas-1.herokuapp.com/home",
            {
              method: "DELETE",
    ...
    document
      .getElementById("view_profile")
      .addEventListener("click", function (e) {
        window.location.replace(
          "https://trainer-atlas-1.herokuapp.com/profile_page"
        );
      });

    //button event for back to homepage
    document
      .getElementById("back_to_homepage")
      .addEventListener("click", function (e) {
  ...
  if (document.title == "complete_profile") {
    ...
    document.getElementById("create_profile2").addEventListener(
      "click",
      function (e) {
