...
const MONGODB_URI =
  "mongodb://brp221:zd20dNXxHq3v6mt9@traineratlascluster-shard-00-00.spuyu.mongodb.net:27017,traineratlascluster-shard-00-01.spuyu.mongodb.net:27017,traineratlascluster-shard-00-02.spuyu.mongodb.net:27017/TrainerAtlasDB?ssl=true&replicaSet=atlas-133zln-shard-0&authSource=admin&retryWrites=true&w=majority";
...
app.get("/home", isLoggedIn, async function (req, res, next) {
  ...
  res.render("home", {
    title: "home",
    trainers: trainer_usernames,
    trainees: trainee_usernames,
  });
});
...
app.get("/profile_page", isLoggedIn, function (req, res, next) {
  ...
  res.render("profile_page", {
    ...
    userType: "Profile Type: " + req.user.UserType,
    email: "Email: " + req.user.Email,
    bio: "Bio: " + req.user.Bio,
    goals: "Goals: " + req.user.Goals,
    experience: "Experience: " + req.user.Experience,
    clients: "Clients: " + req.user.Clients,
  });
});
//GOOGLE OAUTH
app.get(
